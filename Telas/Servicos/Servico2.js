...
export default function ProfileScreen({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.servicesTitle}>CUIDADO INFANTIL E BABÁS</Text>
      <ScrollView>
          ...
          {profissionais.map((profissional) => (
            <View key={profissional.id} style={styles.profissionalItem}>
              <TouchableOpacity
                ...
                onPress={() => navigation.navigate('PrestadorId', { serviceId: 2, id: profissional.id, name: profissional.nome, telefone: profissional.telefone, valor_hora: profissional.valor_hora, media: profissional.media, atendimentos: profissional.atendimentos, avaliacoes: profissional.avaliacaos })}
              >
                <View style={styles.profissionalInfo}>
                  <View style={styles.profissionalProfileCircle}>
                    <Image
                      source={{ uri: 'https://via.placeholder.com/150' }}
                      style={styles.serviceProfileImage}
                    />
                  </View>
                  <View style={styles.profissionalTextContainer}>
                    <Text style={styles.profissionalText}>{profissional.nome}</Text>
