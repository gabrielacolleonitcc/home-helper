...
export default function ProfileScreen({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.servicesTitle}>OUTROS SERVIÇOS</Text>
      <ScrollView>
          ...
          {profissionais.map((profissional) => (
            <View key={profissional.id} style={styles.serviceItem}>
              <TouchableOpacity
                ...
                onPress={() => navigation.navigate('PrestadorId', { serviceId: 6, id: profissional.id, name: profissional.nome, telefone: profissional.telefone, valor_hora: profissional.valor_hora, media: profissional.media, atendimentos: profissional.atendimentos, avaliacoes: profissional.avaliacaos })}
              >
